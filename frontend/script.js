...
function updateAuthUI() {
    if (currentUser) {
        ...
        if (currentUser.role === 'admin') {
            ...
            showToast('Admin mode active - You can edit product prices!', 'success');
        }
...
function showUserMenu() {
        ...
        <div class="user-dropdown-content">
            <div class="user-info">
                ...
                <div>
                    ...
                    <div class="user-role">${currentUser.role === 'admin' ? 'Administrator' : 'Customer'}</div>
                </div>
            </div>
            <hr>
            ...
            <button onclick="viewOrders()" class="dropdown-item">
                <i class="fas fa-shopping-bag"></i> My Orders
            </button>
            <button onclick="viewWishlist()" class="dropdown-item">
                <i class="fas fa-heart"></i> Wishlist
            </button>
            ${currentUser.role === 'admin' ? `
                <hr>
                <button onclick="adminDashboard()" class="dropdown-item admin-item">
    ...
    // Position menu below auth section
    const rect = elements.authSection.getBoundingClientRect();
    menu.style.cssText = `
        position: fixed;
    ...
    setTimeout(() => {
        document.addEventListener('click', function closeMenu(e) {
            if (!menu.contains(e.target) && !elements.authSection.contains(e.target)) {
                menu.remove();
...
function logout() {
    ...
    // Refresh products to hide admin buttons
    if (window.allProducts) {
        renderProducts(window.allProducts);
    }
}
...
function viewWishlist() {
    ...
    showToast('Wishlist view coming soon!', 'warning');
}
